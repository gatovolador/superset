...
// export type ConditionalFormattingConfigMap = {
//   cell: ConditionalFormattingConfig;
//   text: ConditionalFormattingConfig;
// };
...
export type FormattingPopoverProps = PopoverProps & {
  ...
  // configMap?: ConditionalFormattingConfigMap;
  title: string;
  children: ReactNode;
};
