...
import { ControlFormItemSpec, ControlType } from '@superset-ui/chart-controls';
import {
...
export type ControlTypeCustom = 'ConditionalFormattingControl';
...
export type ControlFormItemSpecCustom<
  T extends ControlType | ControlTypeCustom = ControlType | ControlTypeCustom,
> = ControlFormItemSpec &
  (T extends 'ConditionalFormattingControl'
    ? {
        ...
        label?: string;
        description?: string;
        value?: ConditionalFormattingConfig[] | null;
      }
    : {});

export type ControlFormItemDefaultSpec = ControlFormItemSpecCustom<
