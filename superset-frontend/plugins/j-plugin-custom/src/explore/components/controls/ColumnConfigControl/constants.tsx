...
export type SharedColumnConfigProp =
  ...
  | 'textFormatter'
  | 'textFormatColumn'
  | 'textFormatColorScheme'
  | 'textFormatOperator'
  | 'textFormatTargetValue'
  | 'textFormatApply'
  | 'cellFormatColumn'
  | 'cellFormatColorScheme'
  | 'cellFormatOperator'
  | 'cellFormatTargetValue'
  | 'cellFormatApply';
...
// const basicCheckbox: ControlFormItemSpec<'Checkbox'> = {
//   controlType: 'Checkbox',
//   label: t('Checkbox'),
...
const basicSelect: ControlFormItemSpec<'Select'> = {
  controlType: 'Select',
  label: t('Select'),
...
// const basicSlider: ControlFormItemSpec<'Slider'> = {
//   controlType: 'Slider',
//   label: t('Slider'),
...
const basicInput: ControlFormItemSpec<'Input'> = {
  controlType: 'Input',
  label: t('Input'),
  description: t('Input'),
  // width: 120,
...
const basicFormatter: ControlFormItemSpecCustom<'ConditionalFormattingControl'> =
  {
    controlType: 'ConditionalFormattingControl',
    label: t('ConditionalFormattingControl'),
    description: t('ConditionalFormattingControl'),
    value: undefined,
...
export const SHARED_COLUMN_CONFIG_PROPS = {
  ...
  textFormatter: {
    ...basicFormatter,
    label: t('Text Color Formatter'),
    description: t('Text Color Formatter'),
    columnOptions: [
  ...
  textFormatColumn: {
    ...basicSelect,
    label: t('Text Condition Column'),
    description: t('Column used for conditional formatting of TEXT'),
    className: 'tab-text-format-control',
  },
  textFormatColorScheme: {
    ...basicSelect,
    label: t('Text Color Scheme'),
    description: t('Color scheme used for conditional formatting of TEXT'),
    className: 'tab-text-format-control',
  },
  textFormatOperator: {
    ...basicSelect,
    label: t('Text Condition Operator'),
    description: t('Operator for conditional formatting of TEXT'),
    className: 'tab-text-format-control',
  },
  textFormatTargetValue: {
    ...basicInput,
    label: t('Text Condition Target Value'),
    description: t('Target value for conditional formatting of TEXT'),
    className: 'tab-text-format-control',
  },
  textFormatApply: {
    ...basicInput,
  ...
  cellFormatColumn: {
    ...basicSelect,
    label: t('Cell Condition Column'),
    description: t('Column used for conditional formatting of CELL'),
    className: 'tab-cell-format-control',
  },
  cellFormatColorScheme: {
    ...basicSelect,
    label: t('Cell Color Scheme'),
    description: t('Color scheme used for conditional formatting of CELL'),
    className: 'tab-cell-format-control',
  },
  cellFormatOperator: {
    ...basicSelect,
    label: t('Cell Condition Operator'),
    description: t('Operator for conditional formatting of CELL'),
    className: 'tab-cell-format-control',
  },
  cellFormatTargetValue: {
    ...basicInput,
    label: t('Cell Condition Target Value'),
    description: t('Target value for conditional formatting of CELL'),
    className: 'tab-cell-format-control',
  },
  cellFormatApply: {
    ...basicInput,
...
const colorFormattingTab: TabLayoutItem = {
  tab: t('Color Formatting'),
  children: [
    // ['textFormatter'],
    ['textFormatColumn', 'textFormatColorScheme'],
    ['textFormatOperator', 'textFormatTargetValue'],
    ['textFormatApply'],
    ['cellFormatColumn', 'cellFormatColorScheme'],
    ['cellFormatOperator', 'cellFormatTargetValue'],
    ['cellFormatApply'],
  ],
};
